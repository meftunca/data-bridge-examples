...
// MockRecentEventsService, IRecentEventsService arayüzünü taklit eder.
type MockRecentEventsService struct {
	mock.Mock
}
...
func TestGetRecentEventsWithPagination_Success(t *testing.T) {
