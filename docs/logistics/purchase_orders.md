...
| Method | Signature |
|---------|-----------|
| [Create](https://github.com/meftunca/data-bridge-examples/blob/main//logistics/services/PurchaseOrders.go#:~:text=)%20CreatePurchaseOrders() | `(PurchaseOrdersService) CreatePurchaseOrders(data PurchaseOrdersForm) (PurchaseOrdersForm, error)` |
| [Create Multiple](https://github.com/meftunca/data-bridge-examples/blob/main//logistics/services/PurchaseOrders.go#:~:text=)%20CreatePurchaseOrdersMultiple() | `(PurchaseOrdersService) CreatePurchaseOrdersMultiple(data []PurchaseOrdersForm) ([]PurchaseOrdersForm, error)` |
| [Update](https://github.com/meftunca/data-bridge-examples/blob/main//logistics/services/PurchaseOrders.go#:~:text=)%20UpdatePurchaseOrders() | `(PurchaseOrdersService) UpdatePurchaseOrders(id uuid.UUID, data interface{}) error` |
