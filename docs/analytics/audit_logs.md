...
| Method | Signature |
|---------|-----------|
| [Create](https://github.com/meftunca/data-bridge-examples/blob/main//analytics/services/AuditLogs.go#:~:text=%29%20CreateAuditLogs%28%29) | `(AuditLogsService) CreateAuditLogs(data AuditLogsForm) (AuditLogsForm, error)` |
| [Create Multiple](https://github.com/meftunca/data-bridge-examples/blob/main//analytics/services/AuditLogs.go#:~:text=%29%20CreateAuditLogsMultiple%28%29) | `(AuditLogsService) CreateAuditLogsMultiple(data []AuditLogsForm) ([]AuditLogsForm, error)` |
| [Update](https://github.com/meftunca/data-bridge-examples/blob/main//analytics/services/AuditLogs.go#:~:text=%29%20UpdateAuditLogs%28%29) | `(AuditLogsService) UpdateAuditLogs(id uuid.UUID, data interface{}) error` |
| [Update Multiple](https://github.com/meftunca/data-bridge-examples/blob/main//analytics/services/AuditLogs.go#:~:text=%29%20UpdateAuditLogsMultiple%28%29) | `(AuditLogsService) UpdateAuditLogsMultiple(data []AuditLogsBatchUpdate) error` |
| [Delete](https://github.com/meftunca/data-bridge-examples/blob/main//analytics/services/AuditLogs.go#:~:text=%29%20DeleteAuditLogs%28%29) | `(AuditLogsService) DeleteAuditLogs(id uuid.UUID) error` |
